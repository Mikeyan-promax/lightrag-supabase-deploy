...
class QueryParam:
    ...
    mode: Literal["naive", "bypass"] = "naive"
    """Specifies the retrieval mode:
    - "naive": Performs a basic search without advanced techniques (推荐).
    - "bypass": Directly uses LLM without retrieval.
    注意: local/global/hybrid/mix 模式已禁用，因为知识图谱功能已移除。
    """
