...
class QueryRequest(BaseModel):
    ...
    mode: Literal["naive"] = Field(
        default="naive",
        description="Query mode - only naive mode supported (pure vector database retrieval)",
    )
    ...
    max_total_tokens: Optional[int] = Field(
        default=None,
        description="Maximum total tokens budget for the entire query context (chunks + system prompt).",
        ge=1,
    )
